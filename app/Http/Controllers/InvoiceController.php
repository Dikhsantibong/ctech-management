...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'kwitansi_date' => 'nullable|date',
            'kwitansi_signatory' => 'nullable|string|max:255',
        ...
        $invoice = Invoice::create([
            ...
            'kwitansi_date' => $validated['kwitansi_date'] ?? null,
            'kwitansi_signatory' => $validated['kwitansi_signatory'] ?? null,
            'subtotal' => $subtotal,
            'tax' => $tax,
            'total' => $total,
            'status' => 'Draft',
